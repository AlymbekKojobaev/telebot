...
async def welcome(message: Message):
    ...
    welcome_sticker = open('/home/joker/Desktop/dgango/telebot/images/welcome.gif', 'rb')
...
async def confirm_number_for_reservations(message:Message):
...
async def confirm_number_for_order(message:Message, state: FSMContext):
    if message.contact is not None:
